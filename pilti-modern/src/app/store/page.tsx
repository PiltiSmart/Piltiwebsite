              ...
              <div className="absolute top-6 left-6 z-[100] flex items-center gap-2 px-3 py-1.5 rounded-full bg-black/40 border border-white/10 backdrop-blur-md transition-all select-none">
                {isOnline ? (
                  <>
                    ...
                    <span className="text-[10px] uppercase tracking-wider font-semibold text-emerald-400 font-mono">Pilti Store is live</span>
                  </>
                ) : (
                  <>
                    <span className="relative flex h-2 w-2">
                    ...
                    <span className="text-[10px] uppercase tracking-wider font-semibold text-rose-400 font-mono">Pilti Store offline</span>
                  </>
                )}
              </div>
              ...
              {isLoading && !hasError && (
                <div className="absolute inset-0 z-10 bg-[#0D1120] flex flex-col items-center justify-center gap-6">
                  ...
                  <div className="text-center">
                    <p className="text-white/80 font-semibold text-sm mb-1">Loading Pilti Store™</p>
                    <p className="text-white/40 text-xs font-mono">piltistore.com</p>
                  </div>
                </div>
              )}

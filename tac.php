        ...
        <section id="content">
            <div class="container content">
                ...
                <div class="entry-content">
                    ...
                    <p>By accepting a quote, you are considered to have accepted these terms and conditions in full.</p>



                    <p><strong>What do both parties agree to do?</strong></p>
                    ...
                    <p><strong>Project Delivery Dates</strong></p>
                    ...
                    <p>You should supply graphic files in an editable, vector digital format. You should supply
                        photographs in a high resolution digital format. If you choose to buy stock photographs, I can
                        suggest stock libraries. If you’d like me to search for photographs for you, I can provide a
                        separate estimate for that. If you need any advice on these formats I’m always happy to help.
                    </p>



                    <p>I’m not responsible for writing or editing any text copy unless specified in the original
                        estimate. If you’d like me to write new content or edit text for you, I can provide a separate
                        estimate for that.</p>



                    <p>If you want to add anything new or change your mind about something as the project progresses
                        that won’t be a problem. I’m happy to be flexible and will provide a seperate quote as required.
                    </p>
                    ...
                    <p><strong>Project Cancellations</strong></p>
                   ...
                   <!-- <p><strong>Copyrights ******(needs update)******* </strong></p>
                    ...
                    <p>You guarantee that all elements of text, graphics, photos, designs, trademarks, or other artwork
                        you provide are either owned by your company, or that you have permission to use them.</p>
                    ...
                    <p>You’ll own the visual elements that I create for this project. I will give you the finished
                        print-ready or digital files and you should keep them somewhere safe as I’m not required to keep
                        a copy. You own all elements of text, images and data you provided, unless someone else owns
                        them.</p>



                    <p>I’ll own the source files unless we agree otherwise.&nbsp;</p>
                    ...
                    <p>Payment is due within 30 days of date of invoice. Payments should be made by bank transfer,
                        referencing the invoice number. Payments made by cheque must be previously agreed and may be
                        subject to an administration charge.</p>
